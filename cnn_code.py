...
image_size = 0
directory_root = 'C:/Users/abhijith.abhi/Desktop/Code complete/Database'
width=256
height=256
depth=3
...
for disease_folder in root_dir :
    disease_disease_folder_list = listdir(f"{directory_root}/{disease_folder}")
        
     
    for image in disease_disease_folder_list[:]:
